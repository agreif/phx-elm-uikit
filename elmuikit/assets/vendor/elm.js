...
var $author$project$Main$init = F3(
	function (maybeUrlStr, url, key) {
		if (!maybeUrlStr.$) {
			var urlStr = maybeUrlStr.a;
			var _v1 = $elm$url$Url$fromString(urlStr);
			if (!_v1.$) {
				var url2 = _v1.a;
				return _Utils_Tuple2(
					A2($author$project$Main$Model, key, url2),
					A2(
